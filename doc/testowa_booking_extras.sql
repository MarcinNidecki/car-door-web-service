...
INSERT INTO `booking_extras` VALUES (2,'','/img/icon/extra-infant.png','BABY SEAT',26.00),(3,'','/img/icon/extra-booster.png','BOOSTER SEAT',13.00),(4,'','/img/icon/extra-gps.png','GPS',26.00),(5,'','/img/icon/extra-snow-chains.png','SNOW CHAINS',2.00),(1,' Share the driving','/img/icon/extra-driver.png','ADDITIONAL DRIVER',10.00);
...
-- Dump completed on 2019-10-13  1:27:19
